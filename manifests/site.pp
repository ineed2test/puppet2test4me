...
Tomcat::Install['/home/kundea/tomcat'] -> Tomcat::Instance['default'] -> Tomcat::Config::Server::Tomcat_users['manager-gui'] -> Tomcat::Config::Server::Tomcat_users['user1'] -> Class[Kundea::Webserver] -> Service['tomcat'] -> Exec['restart tomcat'] -> Exec['enable apache mod_jk']
